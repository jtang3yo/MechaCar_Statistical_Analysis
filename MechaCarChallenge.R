...
library(dplyr)
# 4. Import and read into MechaCar_mpg.csv file as a dataframe.
library(tidyverse)
...
#2. Use t.test() function 3 more times with subset() to determine if PSI for 
# each manufacturing lot is statistically different from the pop. mean of 1,500 PSI
